...
{
template < class OutputPipeType > class HpxFlowPipelineSegment:public virtual HpxFlowPipelineProcessing::
    HpxFlowPipelineSegmentBase
    
  {
  protected: const static HpxFlowPipelineSegmentBase *const
      OutputPipeType_Substitutable;
    const static unsigned int OutputPipeType_Not_Void =
      (unsigned int) sizeof (OutputPipeType);
  ...
   public: virtual HpxFlowPipelineSegment < OutputPipeType >
      *connectTo (OutputPipeType * output) = 0;
    virtual HpxFlowPipelineSegment < OutputPipeType >
      *disconnectFrom (OutputPipeType * output) = 0;
    ...
    const HpxFlowPipelineSegmentBase *const HpxFlowPipelineSegment <
    OutputPipeType >::OutputPipeType_Substitutable =
    (const OutputPipeType *) 0;
