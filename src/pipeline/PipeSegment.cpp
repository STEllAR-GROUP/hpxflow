  ...
  namespace HpxFlowPipelineProcessing 
{
    ...
    
  {
    ...
     virtual bool removeOutputHandler (HpxFlowPipelineSegmentBase *
					 output) 
    {
    ...
     virtual HpxFlowPipeSegment < OutputPipeType >
      *connectTo (OutputPipeType * output) 
    {
      addOutputHandler (output);
      return this;
    };
     virtual HpxFlowPipeSegment < OutputPipeType >
      *disconnectFrom (OutputPipeType * output) 
    {
