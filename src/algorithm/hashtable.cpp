...
namespace hpx
{
  namespace flow
  {
	...
	hashmap.clear ();
      ...
      template < typename T, typename V > void insert_Item (T key, V value)
      {
	...
	hashmap.insert (make_pair (key, V (value)));
      ...
      template < typename T > void remove_Item (T key)
      {
	hashmap.erase (key);
      }
      ...
      template < typename T, typename V > V get_Item (T key)
      {
